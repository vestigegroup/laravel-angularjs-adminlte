...
<head>
    ...
    @if(config('app.debug'))
        ...
        <link rel="stylesheet" href="{{ asset('/build/vendor/css/ionicons.min.css') }}">
        <link rel="stylesheet" href="{{ asset('/build/css/_all-skins.min.css') }}">
    @else
...
<div class="wrapper">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="build/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="build/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <!-- chat item -->
                            <div class="item">
                                <img src="build/img/user4-128x128.jpg" alt="user image" class="online">
                                <p class="message">
                                    <a href="#" class="name">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="build/img/user3-128x128.jpg" alt="user image" class="offline">
                                <p class="message">
                                    <a href="#" class="name">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="build/img/user2-160x160.jpg" alt="user image" class="offline">
                                <p class="message">
                                    <a href="#" class="name">
    ...
    @if(config('app.debug'))
        ...
        <script src="{{ asset('/build/vendor/js/ui-bootstrap.min.js') }}"></script>
        ...
        {{-- Template --}}
        <script src="{{ asset('build/js/vendor/app.min.js') }}"></script>
        {{-- End Template --}}
