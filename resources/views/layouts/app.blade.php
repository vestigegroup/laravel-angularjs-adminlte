                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="dropdown" uib-dropdown>
                            <a ng-href="#/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" uib-dropdown-toggle>
                                {{ Auth::user()->name }} <span class="caret"></span>
                            </a>

                            <ul class="dropdown-menu" role="menu">
                                <li><a ng-href="#/logout"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
